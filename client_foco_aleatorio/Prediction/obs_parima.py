...
def main():
	...
	for usernum in range(nusers):
		...
		data, frame_nos = [],[]
		# Get data
		data, frame_nos, max_frame,total_objects = get_data(data, frame_nos, args.dataset, args.topic, usernum+1, args.fps, args.offset, milisec, width, height, view_width, view_height)
		# Build model
