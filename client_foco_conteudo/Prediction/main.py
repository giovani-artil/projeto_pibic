...
SILO_ID = os.environ.get("SILO_ID", "conteudo")
...
def get_data(data, frame_nos, dataset, topic, usernum, fps, offset, milisec, width, height, view_width, view_height):
	VIEW_PATH = '/app/client_foco_conteudo/Viewport/'
	OBJ_PATH = '/app/client_foco_conteudo/shared_data/Obj_traj/'
...
def main():
	...
	verify_path = Path(f"/app/client_foco_conteudo/models/{args.topic}/")
	verify_path.mkdir(parents=True, exist_ok=True)

	# Get the necessary information regarding the dimensions of the video
	print("Reading JSON...")
	file = open('/app/client_foco_conteudo/Prediction/meta.json', )
	...
	try:
				with open(f"/app/client_foco_conteudo/models/{args.topic}/{args.topic}_global_fedavg.pkl", "rb") as f:
					global_state_fedavg = pickle.load(f)				
				with open(f"/app/client_foco_conteudo/models/{args.topic}/{args.topic}_global_fedprox.pkl", "rb") as f:
					global_state_fedprox = pickle.load(f)
				with open(f"/app/client_foco_conteudo/models/{args.topic}/{args.topic}_global_scaffold.pkl", "rb") as f:
	...
	for chunk in range(num_chunks):
		...
		path_fedavg = f"/app/client_foco_conteudo/models/{args.topic}/{args.topic}_conteudo_fedavg.pkl"
		path_fedprox = f"/app/client_foco_conteudo/models/{args.topic}/{args.topic}_conteudo_fedprox.pkl"
		path_scaffold = f"/app/client_foco_conteudo/models/{args.topic}/{args.topic}_conteudo_scaffold.pkl"
